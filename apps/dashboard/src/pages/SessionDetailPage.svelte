<script lang="ts">
  ...
  async function loadSelectedSession(): Promise<void> {
    ...
    actionError = null
    actionMessage = null
    if (nextSessionId) await loadSessionDetail(nextSessionId)
  }
  ...
  async function refreshAll(): Promise<void> {
    actionError = null
    actionMessage = null
    await Promise.all([loadSessions(), selectedSessionId ? loadSessionDetail(selectedSessionId) : Promise.resolve(null)])
  }
