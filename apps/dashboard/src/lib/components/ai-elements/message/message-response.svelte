...
<script lang="ts">
  ...
  function addCodeCopyButtons(root: HTMLDivElement): void {
    ...
    for (const codeBlock of codeBlocks) {
      ...
      pre.classList.add('w-full', 'max-w-full', '!overflow-hidden', 'rounded-lg', 'border', 'border-border', 'bg-background')
      ...
      body.dataset.codeBlockBody = 'true'
      body.className = 'max-w-full overflow-x-auto'
