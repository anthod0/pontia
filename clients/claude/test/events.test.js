...
describe("event builders", () => {
    ...
    test("truncates turn input summaries to 200 Unicode characters", () => {
        const event = buildTurnStartedEvent({ ...context, input: "界".repeat(201) });
        expect(event.data.input).toEqual({ summary: "界".repeat(200) });
    });
