...
pub(super) fn write_launch_script(
    ...
    let content = format!(
        r#"#!/usr/bin/env sh
unset PONTIA_SESSION_ID PONTIA_CLIENT_TYPE PONTIA_RUNTIME_INSTANCE_ID PONTIA_WORKSPACE PONTIA_RUNTIME_LOG PONTIA_WORKFLOW_ID PONTIA_WORKFLOW_FILE PONTIA_WORKFLOW_PATCH_ID PONTIA_WORKFLOW_PATCH_REQUEST_FILE
export PONTIA_HOME={}
